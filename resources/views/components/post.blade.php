<div class="w-75 mt-1 mb-1">
    <div class="d-flex justify-content-start  bg-white p-1 rounded-border-post-header-custom">
        ...
        <div  class="w-100 border-0 m-0 h-auto bg-white p-2">
                {{$postContent}}
            </div>

        <div class="shadow d-flex   pt-1 pb-1  rounded-border-post-footer-custom w-100">
            <button type="submit" class="btn btn-w  p-0 w-25  mx-auto rounded-pill border-dark"><i class="fa fa-thumbs-o-up fs-4"></i> Like </button>
            <button type="submit" class="btn btn-w  p-0 w-25  mx-auto rounded-pill border-dark"><i class="fa fa-comment-o  fs-4"></i> Comment</button>
